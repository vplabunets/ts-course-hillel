...
const hw_14_1_1 = require("./hw-14.1");
describe('TodoList Class', () => {
    ...
    let task3;
    beforeEach(() => {
        todoList = new hw_14_1_1.TodoList();
        task1 = new hw_14_1_1.Task('1', 'Task 1', 'First task', true);
        task2 = new hw_14_1_1.Task('2', 'Task 2', 'Second task', false);
        task3 = new hw_14_1_1.Task('3', 'Task 3', 'Third task', true);
    ...
    test('should sort tasks by creation date in ascending order', () => {
        todoList.sort('creationDate', hw_14_1_1.Sorting.Ascending);
