...
const hw_13_1_1_1 = require("./hw-13.1-1");
describe('FootballTeam Tests with DeprecatedMethod Decorator', () => {
    let team;
    beforeEach(() => {
        team = new hw_13_1_1_1.FootballTeam('FC Dreamer', ['Illia Zabarnyi', 'Andrii Lunin', 'Volodymyr Brazhko']);
    });
    test('should warn when calling deprecated oldTactic method', () => {
        console.warn = jest.fn();
        team.oldTactic();
        expect(console.warn).toHaveBeenCalledWith('oldTactic is deprecated and will be removed in a future version. Reason: This tactic is outdated. Use newTactic instead.');
    });
    test('should warn when calling deprecated oldPlayerStats method', () => {
        console.warn = jest.fn();
        team.oldPlayerStats('Diego Maradona');
        expect(console.warn).toHaveBeenCalledWith('oldPlayerStats is deprecated and will be removed in a future version. Reason: This stats method is no longer accurate. Use newPlayerStats instead.');
    });
